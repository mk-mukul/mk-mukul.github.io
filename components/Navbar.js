...
const Navbar = ({bgColor}) => {
  return (
    ...
    {/* <Head>
      ...
      <header className={ bgColor +" z-50 px-12 sticky w-full shadow-md top-0"}>
      ...
      <div className="w-10 fixed bottom-0 left-5 right-auto flex flex-col ">
        <div className="w-[1px] h-10 self-center bg-white"></div>
        ...
        <div className="w-[1px] h-24 self-center bg-white"></div>
      </div>
